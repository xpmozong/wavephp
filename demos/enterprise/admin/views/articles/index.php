...
<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
    <h1 class="page-header">
        文章列表
        <button type="button" class="btn btn-success btn-sm" onclick="javascript:location.href='<?php echo $homeUrl.'articles/modify/0';?>'">添加文章</button>
    </h1>
    <div class="info">
        <select name="cid" id="cid" class="form-control" onchange="changecid()">
