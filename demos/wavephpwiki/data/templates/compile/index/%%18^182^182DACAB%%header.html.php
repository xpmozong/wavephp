...
<link type="text/css" rel="stylesheet" href="<?php echo $this->_tpl_vars['app']->request->baseUrl; ?>
/resouce/css/offcanvas.css"/>
<script type="text/javascript" src="<?php echo $this->_tpl_vars['app']->request->baseUrl; ?>
/resouce/js/jquery.js"></script>
<script type="text/javascript" src="<?php echo $this->_tpl_vars['app']->request->baseUrl; ?>
/resouce/bootstrap/js/bootstrap.min.js"></script>
<link href="<?php echo $this->_tpl_vars['app']->request->baseUrl; ?>
/resouce/google-code-prettify/tomorrow-night-eighties.css" rel="stylesheet" type="text/css" media="all">
<script src="<?php echo $this->_tpl_vars['app']->request->baseUrl; ?>
/resouce/google-code-prettify/prettify.js"></script>
